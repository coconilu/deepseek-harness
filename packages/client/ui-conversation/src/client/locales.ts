...
export const zh = {
  ...
  'mode.tower': 'Tower',
  'mode.tower.title': 'Tower 模式已开启，基准分支 {base}',
  'mode.tower.titlePlain': 'Tower 模式已开启',
...
export const en = {
  ...
  'mode.tower': 'Tower',
  'mode.tower.title': 'Tower mode on, base branch {base}',
  'mode.tower.titlePlain': 'Tower mode on',
