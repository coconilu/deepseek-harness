...
- **No optional shared capabilities** — `agentOptions`, output schemas, child personas, tool filtering, harness depth enforcement, and per-request working directories (`cwd`) are rejected by the shared service for this provider.
