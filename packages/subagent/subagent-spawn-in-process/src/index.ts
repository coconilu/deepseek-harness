 ...
 * route), `toolFilter`/`persona` (scoped `restrict()` and a scoped
 * shadowing persona section, applied in the child's creation window), and
 * `cwd` (stamped as the child session's durable workspace).
 */
